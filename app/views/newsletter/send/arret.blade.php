                                ...
                                <table border="0" width="375" align="left" cellpadding="0" cellspacing="0" class="resetTable">
                                    <tr>
                                        <td valign="top" width="60" class="resetMarge">
                                            <img style="width: 60px;" width="60" border="0" alt="{{ $analyse->auteur->name }}" src="{{ asset('authors/'.$analyse->auteur->photo) }}">
                                        </td>
                                        <td valign="top" width="10" class="resetMarge"></td>
                                        <td valign="top" width="305" class="resetMarge">
                                            <h3 style="text-align: left;font-family: sans-serif;">{{ $analyse->auteur->name }}</h3>
                                            <p style="text-align: left;font-family: sans-serif;">{{ $analyse->auteur->occupation }}</p>
                                        </td>
                                    </tr>
